...
class nof(nn.Module):
    ...
    def forward(self, x):
        ...
        for i, con in enumerate(self.convs):
             ...
             #layer_inner = self.act_fn(con(layer_inner, _layers[0], _layers[-1], update, self.lamda, self.alpha, i + 1))
        ...
        #np.save('coralastlayer_gagwnn.npy',tsne.embedding_)
        #np.save('coralastlayer_gagwnn.npy',mylast.detach().cpu())
