...
class noflayer(nn.Module):
    def __init__(self, nnode, in_features, out_features, adj, max_degree, alpha, lamda, residual=False, variant=False):
    ...
    def inverse_lifting_bases(self, feat_odd_bar, feat_even_bar, P, U,  h0):
        ...
        feat_prime = self.alpha_*feat_even_bar + (1-self.alpha_)*(feat_odd_bar)
        feat_prime = self.lamda*feat_prime + (1-self.lamda)*h0
        return feat_prime
